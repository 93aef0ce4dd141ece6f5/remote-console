 ...
 * Description: Client side program which runs on the remote host
 *              which connects back to the server. Creates a command 
 *              prompt process in which information is received from
 *              the server, piped into the process as a write,  
 *              piped back out as a read and then sent back to the 
 *              server program
 * 
